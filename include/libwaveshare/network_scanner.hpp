...
/// Optional logging callback.  When provided, debug output is routed
/// through this function instead of being printed to stdout/stderr.
...
/// @param log            Optional logging callback.  When null, debug output
///                        goes to stdout/stderr via portable::println.
